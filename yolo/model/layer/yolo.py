...
class YOLO(nn.Module):
    def __init__(self, anchors, num_classes, stride):
        ...
        self.stride = stride  # number of stride (8), (16), (32)
        self.num_outputs = num_classes + 5  # number of outputs (85)

    def forward(self, pred):
        batch_size, _, ny, nx = pred.shape  # bs, 255, 13, 13

        pred = pred.view(batch_size, self.num_anchors, 5 + self.num_classes, ny,
                         nx).permute(0, 3, 4, 1, 2)

        raw = self.decode(pred.clone())
