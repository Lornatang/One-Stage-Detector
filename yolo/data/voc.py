...
from yolo.configs import yolov3_voc
import os
...
if __name__ == "__main__":
    ...
    train_data_path_2007 = os.path.join(yolov3_voc.DATA_PATH,
                                        'VOCtrainval_06-Nov-2007', 'VOCdevkit',
                                        'VOC2007')
    ...
    test_data_path_2007 = os.path.join(yolov3_voc.DATA_PATH,
                                       'VOCtest_06-Nov-2007', 'VOCdevkit',
                                       'VOC2007')
