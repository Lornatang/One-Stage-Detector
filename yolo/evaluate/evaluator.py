...
class Evaluator(object):
    def __init__(self, model, visiual=True):
        ...
        self.pred_result_path = os.path.join(yolov3_voc.PROJECT_PATH, 'data', 'results')
        self.val_data_path = os.path.join(yolov3_voc.DATA_PATH, 'VOCtest_06-Nov-2007', 'VOCdevkit', 'VOC2007')
        self.conf_thresh = yolov3_voc.TEST["CONF_THRESH"]
        self.nms_thresh = yolov3_voc.TEST["NMS_THRESH"]
        self.val_shape =  yolov3_voc.TEST["TEST_IMG_SIZE"]
    ...
    def APs_voc(self, multi_test=False, flip_test=False):
        ...
        for img_ind in tqdm(img_inds):
            ...
            if bboxes_prd.shape[0]!=0 and self.__visiual and self.__visual_imgs < 100:
                ...
                path = os.path.join(yolov3_voc.PROJECT_PATH, "data/results/{}.jpg".format(self.__visual_imgs))
